 ...
 *
 * Served from the custom subdomain kasm-registry.blackfire.tech, so `basePath`
 * is just `/<schema-version>` (no repo-name prefix). The build replaces the
...
const nextConfig = {
  ...
  env: {
    ...
    icon: 'https://kasm-registry.blackfire.tech/1.1/img/blackfire-registry-icon.png',
    listUrl: 'https://kasm-registry.blackfire.tech/',
